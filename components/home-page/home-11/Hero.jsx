...
const Hero = () => {
  ...
  const content = {
    heading: "Temukan Potensi, Wujudkan Masa Depan. Selamat Datang di Zen EduTech.",
    subheading:
      "Pendidikan Anak Slow Learning, Kursus Coding Anak-anak, dan Solusi Software Kustom. ",
    btnText: "Start Now",
  };
